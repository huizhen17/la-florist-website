      ...
      <div class="container">
        <div class="row ">
			<div class="col-md-8 ftco-animate">
					...
					<form method="post" action="edit-post.php" class="contact-form" enctype="multipart/form-data">
						<div class="row">
							<?php
								if(isset($_SESSION['notice'])):?>
									<p style="font-weight:600;color:#32a852;"><?php
										echo $_SESSION['notice']; ?></p>
								<?php endif ;
						...
						<div class="row">
							<div class="col-md-8 form-group">
							  <input type="text" name="blog-title" class="form-control" placeholder="Search for id or title to edit (required)" required>
							</div>
							<div class="form-group">
								<input name="search-edit" type="submit" value="Search" class="btn btn-primary py-3 px-5">
							</div> 
						</div>							
					</form>		
					...
					<?php 
						...
						//user submit the form
						else{ //search post based on the result
							$username = $_SESSION['username'];
							...
							<div class="row">
								<h3>Search For: <?php echo $title; ?></h3>
							</div>	
										...
										<div class="col-lg-12 ftco-animate"> 
											<div class="row">
												...
												<div class="col-lg-3" style="padding-top:10px;" ftco-animate>	
													<!--to particular page-->
													<div class="form-group">
														<a href="edit-single-post.php?id=<?php echo $row["id"];?>" class="btn btn-primary py-3 px-5">Edit</a>
													</div> 							
												</div>
											</div>
											<p>
